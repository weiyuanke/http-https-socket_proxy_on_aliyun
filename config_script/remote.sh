...
if [ $DOCKERMODE = "true" ];then
  ...
  export VPN_IPSEC_PSK=Admin123
  export VPN_USER=vpn
  export VPN_PASSWORD=Admin123
  export VPN_ANDROID_MTU_FIX=yes 
  export VPN_L2TP_NET=10.1.0.0/16 
  export VPN_L2TP_LOCAL=10.1.0.1 
...
STRONGSWAN_USER=vpn
STRONGSWAN_PASSWORD=Admin123
STRONGSWAN_PSK=Admin123
